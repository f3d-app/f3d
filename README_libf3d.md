...
* `window` options are taken into account on the next window::render() call.
  ...
  * `window.camera` options let you configure the camera when not using a `loader.camera.idex` >= 0. The options without default are automatically computed when not provided.
...
|--animation-index
loader.camera.index|-1|int|Select the scene camera to load.<br>Any negative value means custom camera.<br>The default scene should use a custom camera.|--camera-index
...
loader.default.color.rgb|1.0,1.0,1.0|vector<double>|Set a *color* on the geometry/|--color
loader.default.color.opacity|1.0|double|Set *opacity* on the geometry. Usually used with Depth Peeling option.|--opacity
loader.default.color.texture||string|Path to a texture file that sets the color of the object. Can be used with rgb and opacity.|--texture-base-color
loader.default.emissive.texture||string|Path to a texture file that sets the emitted light of the object.|--texture-emissive
...
loader.default.material.roughness|0.3|double|Set the *roughness coefficient* on the geometry (0.0-1.0)|--roughness
loader.default.material.metallic|0.0|double|Set the *metallic coefficient* on the geometry (0.0-1.0).|--metallic
loader.default.material.texture||string|Path to a texture file that sets the Occlusion, Roughness and Metallic values of the object.|--texture-material
...
window.camera.position||vector<double>|The position of the camera.|--camera-position
window.camera.focal-point||vector<double>|The focal point of the camera.|--camera-focal-point
window.camera.view-up||vector<double>|The view up vector of the camera. Will be orthogonalized even when provided.
|--camera-view-up
window.camera.view-angle|0.0|double|The view angle of the camera, non-zero value in degrees.
|--camera-view-angle
window.camera.azimuth-angle|0.0|double|The azimuth angle of the camera in degrees (default: 0.0).<br>This angle will be applied after setting the position of the camera, focal point of the camera, and view up vector of the camera.|--camera-azimuth-angle
window.camera.elevation-angle|0.0|double|The elevation angle of the camera in degrees (default: 0.0).<br>This angle will be applied after setting the position of the camera, focal point of the camera, and view up vector of the camera.|--camera-elevation-angle
