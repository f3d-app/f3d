  ...
  bool parseCommandLine)
{
  ...
  try
  {
    ...
    this->DeclareOption(grp1, "camera-orthographic", "", "Render in Orthographic Project mode", options.getAsBoolRef("camera.orthographic"), LocalHasDefaultNo, MayHaveConfig::YES);
