  ...
  bool parseCommandLine)
{
  ...
  try
  {
    ...
    this->DeclareOption(grp4, "colormap-preset", "", "Specify a colormap preset (ignored if colormap is specified)", options.getAsStringRef("model.scivis.colormap.preset"), HasDefault::YES, MayHaveConfig::YES, "<preset>");
