  ...
  bool parseCommandLine)
{
  ...
  try
  {
    ...
    this->DeclareOption(grpCamera, "camera-orthographic", "", "Use Orthographic Projection for the camera", options.getAsBoolRef("camera.orthographic"), HasDefault::YES, MayHaveConfig::YES);
