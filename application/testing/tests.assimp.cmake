...
if(VTK_VERSION VERSION_GREATER_EQUAL 9.6.20260128)
  f3d_test(NAME TestPipedOFF DATA teapot.off ARGS --up=+Z --load-plugins=assimp PIPED)
  f3d_test(NAME TestPiped3MF DATA cube_gears.3mf ARGS --load-plugins=assimp PIPED)
  f3d_test(NAME TestPipedFBX DATA phong_cube.fbx ARGS --load-plugins=assimp PIPED)
  f3d_test(NAME TestPipedDAE DATA duck.dae ARGS --load-plugins=assimp PIPED) # Texture not loaded
  f3d_test(NAME TestPipedX DATA anim_test.x ARGS --load-plugins=assimp PIPED)
  if (NOT APPLE)
    f3d_test(NAME TestPipedDXF DATA PinkEggFromLW.dxf ARGS --background-color=1,1,1 -p --load-plugins=assimp PIPED)
  endif()
elseif(VTK_VERSION VERSION_GREATER_EQUAL 9.5.20251016)
