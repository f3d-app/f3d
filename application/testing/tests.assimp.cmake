...
f3d_test(NAME TestDXF DATA PinkEggFromLW.dxf ARGS --background-color=1,1,1 -p PLUGIN assimp SKIP_GLES) # GLES doesn't support depth peeling
...
if(VTK_VERSION VERSION_GREATER_EQUAL 9.7.0)
  f3d_test(NAME TestDXFr12 DATA bridge.dxf PLUGIN assimp)
  f3d_test(NAME TestDXFLtrim DATA floorplan.dxf PLUGIN assimp)
endif()
...
if(VTK_VERSION VERSION_GREATER_EQUAL 9.4.20241219 AND "${F3D_ASSIMP_VERSION}" VERSION_GREATER_EQUAL "5.4.3")
  ...
  f3d_test(NAME TestFBXRigArmatureSphereTube DATA punch.fbx ARGS --animation-time=1 --armature --point-size=20 --line-width=5 PLUGIN assimp THRESHOLD 0.06) # Sphere and tube are slightly different on GLES
endif()
...
if(NOT F3D_MACOS_BUNDLE)
  ...
  if(VTK_VERSION VERSION_GREATER_EQUAL 9.5.20251001)
    f3d_test(NAME TestDefaultConfigFileAssimpFBX DATA phong_cube.fbx CONFIG config_build LONG_TIMEOUT UI SKIP_GLES LABELS "plugin;assimp")
    f3d_test(NAME TestDefaultConfigFileAssimpDXF DATA PinkEggFromLW.dxf ARGS -p CONFIG config_build LONG_TIMEOUT UI SKIP_GLES LABELS "plugin;assimp")
    f3d_test(NAME TestDefaultConfigFileAssimpOFF DATA teapot.off CONFIG config_build LONG_TIMEOUT UI SKIP_GLES LABELS "plugin;assimp")
    f3d_test(NAME TestDefaultConfigFileAssimpDAE DATA duck.dae CONFIG config_build LONG_TIMEOUT UI SKIP_GLES LABELS "plugin;assimp")
  endif()
  ...
  f3d_test(NAME TestThumbnailConfigFileAssimpFBX DATA phong_cube.fbx CONFIG thumbnail_build LONG_TIMEOUT DEFAULT_HDRI SKIP_GLES LABELS "plugin;assimp")
  f3d_test(NAME TestThumbnailConfigFileAssimpDXF DATA PinkEggFromLW.dxf ARGS -p CONFIG thumbnail_build LONG_TIMEOUT SKIP_GLES LABELS "plugin;assimp")
  f3d_test(NAME TestThumbnailConfigFileAssimpOFF DATA teapot.off CONFIG thumbnail_build LONG_TIMEOUT SKIP_GLES LABELS "plugin;assimp")
  f3d_test(NAME TestThumbnailConfigFileAssimpDAE DATA duck.dae CONFIG thumbnail_build LONG_TIMEOUT DEFAULT_HDRI SKIP_GLES LABELS "plugin;assimp")
endif()
