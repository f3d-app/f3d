...
f3d_test(NAME TestPipedDRACO DATA suzanne.drc ARGS --load-plugins=draco PIPED Draco)
if(VTK_VERSION VERSION_GREATER_EQUAL 9.5.20250923)
  f3d_test(NAME TestPipedGLTFDracoImporter DATA Box_draco.glb ARGS --load-plugins=draco PIPED GLBDraco)
endif()
