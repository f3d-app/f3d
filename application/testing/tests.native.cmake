...
if(F3D_MODULE_WEBP)
  f3d_test(NAME TestWebP DATA image.webp ARGS --scalar-coloring --up=+Y --coloring-component=-2 --camera-direction=0,0,-1 --camera-orthographic)
endif()
if(F3D_MODULE_EXR)
  f3d_test(NAME TestEXR DATA Rec709.exr ARGS --scalar-coloring --up=+Y --coloring-component=-2 --camera-direction=0,0,-1 --camera-orthographic)
endif()
...
if(VTK_VERSION VERSION_GREATER_EQUAL 9.6.20260106)
  ...
  if(F3D_MODULE_WEBP)
    f3d_test(NAME TestPipedWebP DATA image.webp ARGS --scalar-coloring --up=+Y --coloring-component=-2 --camera-direction=0,0,-1 --camera-orthographic --force-reader=WebP PIPED)
  endif()
  if(F3D_MODULE_EXR)
    f3d_test(NAME TestPipedEXR DATA Rec709.exr ARGS --scalar-coloring --up=+Y --coloring-component=-2 --camera-direction=0,0,-1 --camera-orthographic --force-reader=EXR PIPED)
  endif()
endif()
