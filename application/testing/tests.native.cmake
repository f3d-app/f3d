...
if(VTK_VERSION VERSION_GREATER_EQUAL 9.6.20260106 AND VTK_VERSION VERSION_LESS 9.6.20260128)
  ...
  f3d_test(NAME TestPipedPNG DATA world.png ARGS --camera-orthographic --force-reader=PNG PIPED)
  f3d_test(NAME TestPipedJPG DATA world.jpg ARGS --camera-orthographic --force-reader=JPEG PIPED)
  f3d_test(NAME TestPipedBMP DATA albedo.bmp ARGS --camera-orthographic --force-reader=BMP PIPED)
  f3d_test(NAME TestPipedTGA DATA world.tga ARGS --camera-orthographic --force-reader=TGA PIPED)
  f3d_test(NAME TestPipedHDR DATA palermo_park_1k.hdr ARGS --camera-orthographic --force-reader=HDR PIPED)
  if(F3D_MODULE_WEBP)
    f3d_test(NAME TestPipedWebP DATA image.webp ARGS --camera-orthographic --force-reader=WebP PIPED)
  endif()
  if(F3D_MODULE_EXR)
    f3d_test(NAME TestPipedEXR DATA Rec709.exr ARGS --camera-orthographic --force-reader=EXR PIPED)
  endif()
endif()
...
if(VTK_VERSION VERSION_GREATER_EQUAL 9.6.20260128)
  ...
  f3d_test(NAME TestPipedPNG DATA world.png ARGS --camera-orthographic PIPED)
  f3d_test(NAME TestPipedJPG DATA world.jpg ARGS --camera-orthographic PIPED)
  f3d_test(NAME TestPipedBMP DATA albedo.bmp ARGS --camera-orthographic PIPED)
  f3d_test(NAME TestPipedTGA DATA world.tga ARGS --camera-orthographic PIPED)
  f3d_test(NAME TestPipedHDR DATA palermo_park_1k.hdr ARGS --camera-orthographic PIPED)
  if(F3D_MODULE_WEBP)
    f3d_test(NAME TestPipedWebP DATA image.webp ARGS --camera-orthographic PIPED)
  endif()
  if(F3D_MODULE_EXR)
    f3d_test(NAME TestPipedEXR DATA Rec709.exr ARGS --camera-orthographic PIPED)
  endif()
