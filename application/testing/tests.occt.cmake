...
if(VTK_VERSION VERSION_GREATER_EQUAL 9.5.20251223)
  f3d_test(NAME TestPipedSTEP DATA f3d.stp ARGS --load-plugins=occt --up=+Z PIPED STEP)
  f3d_test(NAME TestPipedBREP DATA f3d.brep ARGS --load-plugins=occt --up=+Z PIPED BREP)
  f3d_test(NAME TestPipedBinaryBREP DATA f3d.bin.brep ARGS --load-plugins=occt --up=+Z PIPED BREP)
endif()
...
if(F3D_PLUGIN_OCCT_COLORING_SUPPORT)
  ...
  if(VTK_VERSION VERSION_GREATER_EQUAL 9.5.20251223)
    f3d_test(NAME TestPipedXBF DATA f3d.xbf ARGS --load-plugins=occt --up=+Z PIPED XBF)
  endif()
