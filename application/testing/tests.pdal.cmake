...
if(NOT F3D_MACOS_BUNDLE)
  ...
  if(VTK_VERSION VERSION_GREATER_EQUAL 9.5.20251001)
    f3d_test(NAME TestDefaultConfigFileLAS DATA warsaw_small.las CONFIG config_build LONG_TIMEOUT LABELS "plugin;pdal")
    ...
    f3d_test(NAME TestDefaultConfigFileTerraScanBin DATA 20020715-time-color.bin CONFIG config_build LONG_TIMEOUT LABELS "plugin;pdal")
    f3d_test(NAME TestDefaultConfigFileCSD DATA sample.csd ARGS --camera-view-angle=15 --camera-zoom-factor=1 --camera-position=-10,10,-10 CONFIG config_build LONG_TIMEOUT LABELS "plugin;pdal")
    f3d_test(NAME TestDefaultConfigFilePCD DATA autzen-utm.pcd CONFIG config_build LONG_TIMEOUT LABELS "plugin;pdal")
  endif()
  ...
  f3d_test(NAME TestThumbnailConfigFileCSD DATA sample.csd ARGS --camera-view-angle=15 --camera-zoom-factor=1 --camera-position=-10,10,-10 CONFIG thumbnail_build LONG_TIMEOUT LABELS "plugin;pdal")
