...
if(VTK_VERSION VERSION_GREATER_EQUAL 9.5.20251210)
  f3d_test(NAME TestPipedVDBVolume DATA icosahedron.vdb PLUGIN vdb ARGS --volume --volume-inverse --force-reader=VDB PIPED)
endif()
...
if(NOT F3D_MACOS_BUNDLE)
  ...
  if(VTK_VERSION VERSION_GREATER_EQUAL 9.5.20251001)
    f3d_test(NAME TestDefaultConfigFileVDB DATA icosahedron.vdb CONFIG config_build LONG_TIMEOUT TONE_MAPPING UI LABELS "plugin;vdb")
  endif()
  ...
  f3d_test(NAME TestThumbnailConfigFileVDB DATA icosahedron.vdb CONFIG thumbnail_build LONG_TIMEOUT TONE_MAPPING LABELS "plugin;vdb")
endif()
