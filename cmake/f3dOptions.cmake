  ...
  foreach(_json_idx RANGE ${_options_length})
    ...
    if(_option_type_error STREQUAL "NOTFOUND" AND ${_option_type_type} STREQUAL "STRING")
       ...
       if(_domain_range_error STREQUAL "NOTFOUND")
         ...
         string(APPEND _options_domains_struct "${_option_indent}    domain_range_t<${_option_domain_type}> ${_member_name} = {{${_option_domain_range}}, ${_option_domain_increment}};\n")
       else()
         if(_domain_enum_error STREQUAL "NOTFOUND")
           string(APPEND _options_domains_struct "${_option_indent}    domain_enum_t<${_option_domain_type}> ${_member_name} = {{${_option_domain_enum}}};\n")
         endif()
       endif()
