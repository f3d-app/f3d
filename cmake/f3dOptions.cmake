...
function(_parse_json_option _top_json)
  ...
  foreach(_json_idx RANGE ${_options_length})
    ...
    if(_option_type_error STREQUAL "NOTFOUND" AND ${_option_type_type} STREQUAL "STRING")
       ...
       set(_option_deprecated_guard_begin "")
       set(_option_deprecated_guard_end "")
       ...
       list(APPEND _options_setter "if (name == \"${_option_name}\") { ${_option_deprecated_guard_begin}opt.${_option_name} = ${_option_explicit_constr}{std::get<${_option_variant_type}>(value)}\; ${_option_deprecated_guard_end} }")
       list(APPEND _options_getter "if (name == \"${_option_name}\") { ${_option_deprecated_guard_begin}return opt.${_option_name}${_optional_getter}${_option_variant_convert}\; ${_option_deprecated_guard_end} }")
       list(APPEND _options_string_setter "if (name == \"${_option_name}\") { ${_option_deprecated_guard_begin}opt.${_option_name} = options_tools::parse<${_option_actual_type}>(str)\; ${_option_deprecated_guard_end} }")
       list(APPEND _options_string_getter "if (name == \"${_option_name}\") { ${_option_deprecated_guard_begin}return options_tools::format(opt.${_option_name}${_optional_getter})\; ${_option_deprecated_guard_end} }")
