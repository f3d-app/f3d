...
function (f3d_generate_options)
  ...
  list(JOIN _options_get_index_domain ";\n  else " _options_get_index_domain)
...
function(_parse_json_option _top_json)
    ...
    if(_option_type_error STREQUAL "NOTFOUND" AND ${_option_type_type} STREQUAL "STRING")
       ...
       if(_domain_style_error STREQUAL "NOTFOUND")
         ...
         if(_option_domain_style STREQUAL "range")
           ...
           list(APPEND _options_get_index_domain "if (name == \"${_option_name}\") throw options::incompatible_exception(\"Trying to get index domain of \" + std::string(\"${_option_name}\") + \" which doesn't have such domain\")")
           ...
           if(_option_domain_style STREQUAL "enum")
             ...
             list(APPEND _options_get_range_domain "if (name == \"${_option_name}\") throw options::incompatible_exception(\"Trying to get range domain of \" + std::string(\"${_option_name}\") + \" which doesn't have such domain\")")
             ...
             if(_option_domain_style STREQUAL "index")
               ...
               list(APPEND _options_get_range_domain "if (name == \"${_option_name}\") throw options::incompatible_exception(\"Trying to get range domain \" + std::string(\"${_option_name}\") + \" which doesn't have such domain\")")
               ...
               list(APPEND _options_get_index_domain "if (name == \"${_option_name}\") return opt.domains.${_option_name}")
               list(APPEND _options_increase_decrease "if (name == \"${_option_name}\") options_tools::increaseDecrease<Up>(opt.${_option_name}, opt.domains.${_option_name})")
               list(APPEND _options_cycle "if (name == \"${_option_name}\") options_tools::cycle(opt.${_option_name}, opt.domains.${_option_name})")
             endif()
           endif()
       ...
       # No domain
         ...
         list(APPEND _options_get_range_domain "if (name == \"${_option_name}\") throw options::incompatible_exception(\"Trying to get range domain \" + std::string(\"${_option_name}\") + \" which doesn't have one\")")
         ...
         list(APPEND _options_get_index_domain "if (name == \"${_option_name}\") throw options::incompatible_exception(\"Trying to get index domain \" + std::string(\"${_option_name}\") + \" which doesn't have one\")")
         list(APPEND _options_increase_decrease "if (name == \"${_option_name}\") throw options::incompatible_exception(\"Trying to increase or decrease \" + std::string(\"${_option_name}\") + \" which is not compatible\")")
  ...
  set(_options_get_index_domain ${_options_get_index_domain} PARENT_SCOPE)
