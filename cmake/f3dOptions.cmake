  ...
  foreach(_json_idx RANGE ${_options_length})
    ...
    if(_option_type_error STREQUAL "NOTFOUND" AND ${_option_type_type} STREQUAL "STRING")
       ...
       if(_domain_range_error STREQUAL "NOTFOUND")
         ...
         list(APPEND _options_has_domain "if (name == \"${_option_name}\") return options_tools::domainer(style, options::domain_style::RANGE)")
         ...
         if(_domain_enum_error STREQUAL "NOTFOUND")
           ...
           list(APPEND _options_has_domain "if (name == \"${_option_name}\") return options_tools::domainer(style, options::domain_style::ENUM)")
