  ...
  foreach(_json_idx RANGE ${_options_length})
    ...
    if(_option_type_error STREQUAL "NOTFOUND" AND ${_option_type_type} STREQUAL "STRING")
       ...
       if (_domain_error STREQUAL "NOTFOUND")
         ...
         string(JSON _option_domain_bool ERROR_VARIABLE _domain_bool_error GET ${_option_domain} "bool")
       else ()
         set(_domain_range_error "")
         set(_domain_increment_error "")
         set(_domain_enum_error "")
         set(_domain_bool_error "")
       endif ()
       ...
       if(_domain_range_error STREQUAL "NOTFOUND")
         ...
         list(APPEND _options_cycle "if (name == \"${_option_name}\") throw options::incompatible_exception(\"Trying to increase \" + std::string(\"${_option_name}\") + \" with incompatible type\")")
       else()
         if(_domain_enum_error STREQUAL "NOTFOUND")
           ...
           list(APPEND _options_increase "if (name == \"${_option_name}\") throw options::incompatible_exception(\"Trying to cycle \" + std::string(\"${_option_name}\") + \" with incompatible type\")")

           if(_domain_bool_error STREQUAL "NOTFOUND")
             list(APPEND _options_cycle "if (name == \"${_option_name}\") options_tools::cycle(opt.${_option_name}, opt.domains.${_option_name}, opt.${_option_domain_bool})")
           else()
