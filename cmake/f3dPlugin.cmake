...
macro(f3d_plugin_build)
  ...
  set(F3D_PLUGIN_JSON_FILE "${CMAKE_BINARY_DIR}/$<CONFIG>/share/f3d/plugins/${F3D_PLUGIN_NAME}.json")

  file(GENERATE OUTPUT "${F3D_PLUGIN_JSON_FILE}" CONTENT "${F3D_PLUGIN_JSON}")
