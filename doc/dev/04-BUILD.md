...
- [VTK](https://vtk.org) >= 9.3.0 (9.6.0 recommended).
- A C++17 compiler.
...
- `F3D_MODULE_UI`: Support for clipboard interaction. Uses provided clip. Experimental and not used yet. Disabled by default.
