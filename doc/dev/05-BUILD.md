...
- `F3D_MODULE_CLIP`: Support for clipboard interaction, used by the application to save/load statefiles to/from the system clipboard. Uses provided clip. Experimental. Disabled by default.
