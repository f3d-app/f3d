...
Contributors are those who have made multiple contributions to the Project and want to be acknowledged as such. Returning Contributors are also very much welcome to share their ideas and feedbacks about the development and maintenance of F3D. Returning have also the `triage` role, which allow them to add labels to issues and run continuous integration on pull requests, which they are very welcome to do to the beft of their knowledge.
