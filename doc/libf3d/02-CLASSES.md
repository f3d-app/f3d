...
It contains the animation API to start and stop animation, go to frames or keyframes, as well as recover the number of available animations and their names.
