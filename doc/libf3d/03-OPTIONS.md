...
### `scene.animation.speed_factor` (_ratio_, default: `1`, range: `[0, 2]`, increment: `0.1` )
...
### `scene.camera.index` (_int_, optional, **on load**, enumeration: dynamic)
...
### `render.backface_type` (_string_, optional, **on load**, enumeration: `visible, hidden`)
