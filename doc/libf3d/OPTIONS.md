...
|         render.grid.color          |    color<br><span style="color:rgb(0, 0, 0)">&#9632;</span>0, 0, 0<br>render     | Set the color of grid lines.                                                                                                                                              |                            \-\-grid-color                            |
...
|      render.background.color       | color<br><span style="color:rgb(51, 51, 51)">&#9632;</span>0.2,0.2,0.2<br>render | Set the window _background color_.<br>Ignored if a _hdri_ skybox is used.                                                                                                 |                         \-\-background-color                         |
