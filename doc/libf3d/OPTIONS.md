...
|   model.scivis.discretization    |   int<br>optional<br>render    | Set how many distinct colors will be used from the colormap. \[1, N\] will discretize, values outside that range will result in smooth shading.                                                                                                                                                    |      \-\-colormap      |
