 ...
 * Linux: `${XDG_CONFIG_HOME}/.config/f3d/config.json`, `~/.config/f3d/config.json`, `/etc/f3d/config.json`, `/usr/share/f3d/configs/config.json`, `[install_dir]/share/f3d/configs/config.json`
 * Windows: `%APPDATA%\f3d\config.json`, `[install_dir]\share\f3d\configs\config.json`
