...
| \-\-recursive-dir-add                                | bool<br>false      | When opening a directory, choose if they should be recursively added or not. If not, only the file in the provided directory will be added.                                                                            |
