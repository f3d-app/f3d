...
Options|Default|Description
------|------|------
\-\-camera-position=\<X,Y,Z\>||Set the camera position, override --camera-direction and camera-zoom-factor.
...
\-\-camera-zoom-factor=\<X,Y,Z\>||Set the camera zoom factor relative to the autozoom on data, a non-zero value.
