...
| \-\-color=\<R,G,B\>                         | vector\<double\><br>- | Set a _color_ on the geometry. Multiplied with the base color texture when present. <br>Model specified by default.                                                                                                                                                                                                                      |
...
| Options                         | Type<br>Default                   | Description                                                                                          |
| ------------------------------- | --------------------------------- | ---------------------------------------------------------------------------------------------------- |
| \-\-background-color=\<R,G,B\>  | vector\<double\><br>0.2, 0.2, 0.2 | Set the window _background color_.<br>Ignored if _hdri_ is set.                                      |
