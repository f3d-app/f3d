...
#define F3D_SILENT_WARNING_DECL(MSVC_CODE, GNU_STRING) _Pragma("clang diagnostic ignored \"-W" #GNU_STRING "\"")
...
#define F3D_SILENT_WARNING_DECL(MSVC_CODE, GNU_STRING) _Pragma("GCC diagnostic ignored \"-W" #GNU_STRING "\"")
