...
interactor& interactor_impl::initCommands()
{
  ...
  this->addCommand("yaw_camera",
    [&](const std::vector<std::string>& args)
    {
      check_args(args, 1, "yaw_camera");
...
interactor& interactor_impl::initBindings()
{
  ...
  this->addBinding({mod_t::ANY, "2"}, "yaw_camera -90", "Camera", std::bind(docStr, "Rotate camera right"));
  ...
  this->addBinding({mod_t::ANY, "8"}, "azimuth_camera -90", "Camera", std::bind(docStr, "Rotate camera right"));
