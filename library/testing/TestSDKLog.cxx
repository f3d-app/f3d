...
int TestSDKLog(int argc, char* argv[])
{
  ...
  f3d::log::print(f3d::log::VerboseLevel::QUIET, "Test Print Quiet Coloring");
  f3d::log::print(f3d::log::VerboseLevel::DEBUG, "Test Print Debug Coloring");
  f3d::log::print(f3d::log::VerboseLevel::INFO, "Test Print Info Coloring");
  f3d::log::print(f3d::log::VerboseLevel::WARN, "Test Print Warning Coloring");
  f3d::log::print(f3d::log::VerboseLevel::ERROR, "Test Print Error Coloring");
