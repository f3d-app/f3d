...
int TestSDKOptions([[maybe_unused]] int argc, [[maybe_unused]] char* argv[])
{
  ...
  test("direction to string", ssDir.str(), "-Z"s);
  ...
  test(
    "getAllNames find", std::ranges::find(names, "render.point_size") != names.end());
