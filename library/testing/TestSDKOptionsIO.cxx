...
int TestSDKOptionsIO(int argc, char* argv[])
{
  ...
  test.parse_expect<f3d::color_t, parsing_exception>("invalid color_t", "rgb(300,255,255)");
  test.parse_expect<f3d::color_t, parsing_exception>("invalid color_t", "hsl(361,120,255)");
  test.parse_expect<f3d::color_t, parsing_exception>("invalid color_t", "hsv(100,120%,0)");
  test.parse_expect<f3d::color_t, parsing_exception>("invalid color_t", "hxb(240,0%,0%)");
  test.parse_expect<f3d::color_t, parsing_exception>("invalid color_t", "0.1,0.2,0.3,0.4");
