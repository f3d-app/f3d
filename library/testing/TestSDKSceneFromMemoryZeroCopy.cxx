  ...
  f3d::mesh_view::memory_view_t getMemoryView(double) const override
  {
    ...
    return { .pointCount = this->Grid.Vertices.size(),
             ...
             .polygons = {
               ...
               .offsets = { .name = "custom_face_offsets_name", .type = f3d::mesh_view::data_type::I32, .data = this->Grid.FaceOffsets.data(), .timeDependent = false },
               .indexCount = this->Grid.Quads.size(),
               .indices = { .name = "custom_face_indices_name", .type = f3d::mesh_view::data_type::I32, .data = this->Grid.Quads.data(), .timeDependent = false } },
