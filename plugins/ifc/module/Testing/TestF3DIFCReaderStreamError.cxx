...
int TestF3DIFCReaderStreamError(int vtkNotUsed(argc), char* argv[])
{
  ...
  {
    std::cerr << "Expected no geometry from invalid stream" << std::endl;
    return EXIT_FAILURE;
  }

  std::cout << "Stream error handling test passed" << std::endl;
