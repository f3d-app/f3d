...
def test_interaction_command():
    ...
    inter.add_interaction_command("P", f3d.Interactor.ModifierKeys.NONE, ["dummy command"])
    inter.add_interaction_command("P", f3d.Interactor.ModifierKeys.CTRL, ["dummy command"])
    inter.add_interaction_command("P", f3d.Interactor.ModifierKeys.SHIFT, ["dummy command"])
    inter.add_interaction_command("P", f3d.Interactor.ModifierKeys.CTRL_SHIFT, ["dummy command"])
