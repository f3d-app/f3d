...
const settings = {
  ...
  runAfter: (Module) => {
    ...
    utils.assert(scene.animationKeyFrames().length === 50, "KeyFrames length should be 50");
    utils.assert(scene.animationKeyFrames()[0] === 0, "First KeyFrame should be 0");
    utils.assert(scene.animationKeyFrames()[49] === 4.0, "First KeyFrame should be 4.0");
